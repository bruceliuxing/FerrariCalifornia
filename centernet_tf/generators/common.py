...
from augmentor.transform import adjust_transform_for_image,transform_aabb,apply_transform
...
class Generator(keras.utils.Sequence):
    ...
    def compute_targets(self, image_group, annotations_group):
        """
        Not Use!Because the defination of train model contains the ground truth;
        The ground truth has generated in func:compute_inputs;
